...
-   The structure of the presentation must follow the structure of the [final project](#final-report)
-   Once done, you must add me ([ovande.furtado\@csun.edu](mailto:ovande.furtado@csun.edu){.email}) as "Commenter" of the Google Slides so that I can provide feedback to the presentation.
-   Click on the link below to learn how to add me as commenter.
    -   <https://www.screencast.com/t/brGgeGfW7qA>
...
\_Hint 3: Ensure to phrase your results following the APA Style ([https://bit.ly/2HirVLv)\_](https://bit.ly/2HirVLv)_){.uri}
