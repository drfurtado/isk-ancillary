...
\date{Last updated on 2022-03-29}
...
You will be given 15 minutes to present the results of your project - 10 minutes (presenting) and 5 minutes (questions). You will be required to use PowerPoint, Google Slides, or something similar. I have created \protect\hyperlink{presentation-template}{PPTX template} you can use to get started.
...
\hypertarget{presentation-template}{%
\subsection{Presentation Template}\label{presentation-template}}

Students will be required to use a template created for the purpose of presenting the results of their project. Simply download the \href{pres-template.pptx}{PPTX template} and open it using MS PowerPoint. You can also import it to Keynote, Google Slides if needed. Please, do a search online to find out how this can be accomplished.
