...
### 1. Dependent (DV) and independent variable (IV)
...
### 2. Hypothesis(ses) for each of the dependent variable(s)
...
### 4. Search for related articles {#articles}
...
Once you find the articles, read and summarize them [create annotated bibliography entries for each](https://bit.ly/2YIGK2t). Note that you will be required to submit the links to the 3 articles and the annotated bibliography entries for each of the 3 articles before the [deadline](#deadlines).
