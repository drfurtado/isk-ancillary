---
title: "Stats Project - KIN610 [Dr. Furtado]"
date: "`r Sys.Date()`"
author: Furtado, JR., O
output:
...
In a nutshell, you will be assigned a research question and be given a data set (link above). Then, after running the appropriate statistical model, you can proceed to write your research report.

## Preliminary information {#prelim-info}

Before running the statistical test to answer your research question, you will be asked to complete four steps:

1. Search related articles + 2-page summary
2. Identify the DV and IV
3. State the Null (Ho) and Research hypotheses (Ha)
4. Choose the statistical model to test your Null hypothesis (Ho)
...
Once you find the articles, read and summarize them. Then, proceed to write a 2-page summary that will be part of the `Introduction` section of the final project. Note that you will need to turn in the 2-page summary.

### 2. Dependent (DV) and independent variable (IV)
...
Once you are assigned a number, refer to [Appendix A](#appendix-a) to identify the research question associated with your assigned #.
...
| Due Date | What to do |
|:---------|:---------------|
|10/19/21| submit items 2-4 of [Preliminary Info](#prelim-info) |
|10/26/21 | [3 related articles](#articles) |
|11/02/21 | 2-page introduction |
|11/09/21 | submit an outline of the presentation* |
|12/14/21 | Present  |
|12/20/21 | submit written report |
