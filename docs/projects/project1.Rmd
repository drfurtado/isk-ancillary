...
Then, **in a separate assignment**, write a 2-page summary that will be part of the `Introduction` section of the final project. Note that you will need to turn in the 2-page summary by the [deadline](#deadlines).
