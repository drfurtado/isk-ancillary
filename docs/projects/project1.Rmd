...
_Hint: copy the [template](#templates) associated with this assignment and paste it into a Google Doc document._
...
_Hint: Use the guidelines from Dr. McLeod (https://bit.ly/3C46nbw) when writing the `Introduction`._
...
_Hint 1: Download and read this article (https://bit.ly/31skJ5I) that covers the best practices of Methods/Results/Conclusion write-ups._

_Hint 2: Follow the example proposed by Dr. McLeod (https://bit.ly/3fptZzD)._ 

_Hint 3: Ensure to phrase your results following the APA Style (https://bit.ly/2HirVLv)_
...
_Hint: use `position_labels` for this analysis._
