...
\tightlist
\item
  You will be required to create a presentation to present the results of your final project using Google Slides.
\item
  The structure of the presentation must follow the structure of the \protect\hyperlink{final-report}{final project}
\item
  Once done, you must add me (\href{mailto:ovande.furtado@csun.edu}{\nolinkurl{ovande.furtado@csun.edu}}) as ``Commenter'' of the Google Slides so that I can provide feedback to the presentation.
\item
  Click on the link below to learn how to add me as commenter.

  \begin{itemize}
  \tightlist
  \item
    \url{https://www.screencast.com/t/brGgeGfW7qA}
  \end{itemize}
\end{itemize}
...
\_Hint 3: Ensure to phrase your results following the APA Style (\href{https://bit.ly/2HirVLv}{https://bit.ly/2HirVLv)\_}\_)\{.uri\}
...
\hypertarget{google-slides-template}{%
\subsection{Google Slides Template}\label{google-slides-template}}

\begin{verbatim}
Refer to the Google Slides template --> https://bit.ly/kin610-presentation-template
\end{verbatim}
